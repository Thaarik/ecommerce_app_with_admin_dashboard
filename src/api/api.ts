...
export const getProductsAndCategories = () => {
  return useQuery({
    queryKey: ["products", "categories"], // for caching purpose
    queryFn: async () => {
...
export const getCategoryAndProduct = (categorySlug: string) => {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (categoryError || !category) {
        throw new Error("Error fetching data " + categoryError?.message);
      }
      ...
      if (productsError) {
        throw new Error("Error fetching data " + productsError.message);
      }

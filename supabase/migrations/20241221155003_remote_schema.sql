...
begin 
    ...
    new.raw_user_meta_data=jsonb_set(new.raw_user_meta_data, '{avatar_url}','"https://www.freepik.com/free-psd/contact-icon-illustration-isolated_397057724.htm#fromView=keyword&page=1&position=1&uuid=146d2093-5b42-4fc4-a98e-7c24d9ed2ba6"'::jsonb);
  end if;
...
-- On Auth user creation, insert into public.users
create
...
CREATE POLICY "Allow all operations for authusers" ON "public"."order_item" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Enable Update for Admins only" ON "public"."category" FOR UPDATE USING ((( SELECT "users"."type"
   FROM "public"."users"
